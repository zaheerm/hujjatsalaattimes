...
//Tasks/Events
					...
					jQuery.fn.generateEvents = function(year, month, day) {
						...
						var returnable = '';
                                                var obj = prayer_times[month-1][day];
                                                var the_date = new Date(year, month, day, 0, 0, 0, 0);
                                                the_date.setUTCHours(obj["imsaak"].substr(0,2));
                                                var imsaak = "" + the_date.getHours() + obj["imsaak"].substr(2);
                                                if (the_date.getHours() < 10) imsaak = "0" + imsaak;
                                                the_date.setUTCHours(obj["fajr"].substr(0,2));
                                                var fajr = "" + the_date.getHours() + obj["fajr"].substr(2);
                                                if (the_date.getHours() < 10) fajr = "0" + fajr;
                                                the_date.setUTCHours(obj["sunrise"].substr(0,2));
                                                var sunrise = "" + the_date.getHours() + obj["sunrise"].substr(2);
                                                if (the_date.getHours() < 10) sunrise = "0" + sunrise;
                                                the_date.setUTCHours(obj["zohr"].substr(0,2));
                                                var zohr = "" + the_date.getHours() + obj["zohr"].substr(2);
                                                the_date.setUTCHours(obj["sunset"].substr(0,2));
                                                var sunset = "" + the_date.getHours() + obj["sunset"].substr(2);
                                                the_date.setUTCHours(obj["maghrib"].substr(0,2));
                                                var maghrib = "" + the_date.getHours() + obj["maghrib"].substr(2);

                                                returnable += '<li><span>' + imsaak + '</span>Imsaak</li><li><span>' + fajr + '</span>Fajr</li><li><span>' + sunrise + '</span>Sunrise</li>';
                                                returnable += '<li><span>' + zohr + '</span>Zohr</li><li><span>' + sunset + '</span>Sunset</li><li><span>' + maghrib + '</span>Maghrib</li>';
